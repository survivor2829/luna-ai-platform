          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-100">
                ...
                <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">会员等级</th>
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <p className="text-gray-400 text-xs mt-1">留空表示永久</p>
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">绑定智能体ID (JSON数组)</label>
                <input
                  type="text"
